			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post" action="./process-login.php">
					...
					<div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="uName" placeholder="Tài khoản" required oninvalid="this.setCustomValidity('Bạn cần điền tên đăng nhập')" oninput="this.setCustomValidity('')">
